...
$result = mysqli_query($db, "SELECT * FROM peminjam WHERE username = '$username' AND (bukunya LIKE '%$keyword%' OR kode_buku LIKE '$keyword' OR kategori LIKE '$keyword%' OR tanggal_pinjam LIKE '$keyword%' OR tanggal_pengembalian LIKE '$keyword%') ORDER BY id DESC LIMIT {$page->awalData()},{$page->dataPerhalaman()}");
?>
<!-- isi data -->
<div class="isi-data">
    <div class="data">
