...
$penerbit = mysqli_query($db, "SELECT * FROM buku WHERE penerbit LIKE '%$key%' ORDER BY id DESC LIMIT {$page->awalData()},{$page->dataPerhalaman()}");
            ...
            <tbody width="100%" cellspacing="10">
                ...
                foreach ($penerbit as $penerbitnya):
                    ...
                    <tr cellspacing="10">
                        ...
                        <td>
                            <button onclick="
                                $('.popup').load('../Welcome/component/result/fraction_group.php?bukid=<?= $penerbitnya['id'] ?>');
